                        ...
                        $.each(wglParallax.items, function(index, value) {
                            if (value.hide_on_mobile) {
                                if (jQuery(window).width() <= value.hide_mobile_resolution) {
                                    jQuery('.extended-parallax[data-item-id="' + value._id + '"]').css({
                                        'opacity': '0',
                                        'visibility': 'hidden'
                                    });
                                } else {
                        ...
                        $.each(wglParallax.items, function(index, value) {
                            if (value.hide_particles_on_mobile) {
                                if (jQuery(window).width() <= value.hide_particles_mobile_resolution) {
                                    jQuery('.wgl-particles-js[data-item-id="' + value._id + '"]').css({
                                        'opacity': '0',
                                        'visibility': 'hidden'
                                    });
                                } else {
                    ...
                    if (wglParallax.backEndVars) {
                        if (wglParallax.backEndVars.hide_particles_img_on_mobile) {
                            if (jQuery(window).width() <= wglParallax.backEndVars.hide_particles_img_mobile_resolution) {
                                jQuery('.wgl-particles-img-js[data-item-id="' + wglParallax.backEndVars.__itemID + '"]').css({
                                    'opacity': '0',
                                    'visibility': 'hidden'
                                });
                            } else {
                        ...
                        $.each(wglDynamicHighlights.items, function(index, value) {
                            if (value.hide_dynamic_highlights_on_mobile) {
                                if (jQuery(window).width() <= value.hide_dynamic_highlights_mobile_resolution) {
                                    jQuery('.wgl-dynamic-highlights-js[data-item-id="' + value._id + '"]').css({
                                        'opacity': '0',
                                        'visibility': 'hidden'
                                    });
                                } else {
                        ...
                        $.each(wglMorph.items, function(index, value) {
                            if (value.hide_morph_on_mobile) {
                                if (jQuery(window).width() <= value.hide_morph_mobile_resolution) {
                                    jQuery('.wgl-morph-js[data-item-id="' + value._id + '"]').css({
                                        'opacity': '0',
                                        'visibility': 'hidden'
                                    });
                                } else {
                ...
                hideWaveOnMobile = function(settings) {
                    if (settings.wave_hide_on_mobile) {
                        if (jQuery(window).width() <= settings.wave_hide_mobile_resolution) {
                            jQuery('.wgl-wave[data-item-id="' + wglWave.itemId + '"]').css({
                                'visibility': 'hidden'
                            });
                        } else {
                            jQuery('.wgl-wave[data-item-id="' + wglWave.itemId + '"]').css({
